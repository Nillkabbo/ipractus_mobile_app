    ...
    >
      ...
      >
        <View style={styles.content}>
          ...
          {/* Login heading with avatar icon (from Sports Frontend login-avatar-w.svg) */}
          ...
          <View style={styles.form}>
            ...
            <View style={styles.fieldGroup}>
              ...
              <View style={styles.passwordInputWrapper}>
                <RNTextInput
                  style={[styles.inputWithIcon, passwordFocused && styles.inputFocused]}
                  value={password}
            ...
            {/* Bottom row: signup text left, Log In button right */}
      ...
      {/* Bottom wave SVG from Sports Frontend auth-wave-l.svg */}
...
const styles = StyleSheet.create({
  wrapper: {
    flex: 1,
    backgroundColor: authColors.backgroundNavy,
  },
  container: {
    flex: 1,
    backgroundColor: authColors.backgroundNavy,
  ...
  input: {
    width: '100%',
    height: 45,
    backgroundColor: authColors.cardDark,
    borderRadius: 5,
    borderWidth: 1,

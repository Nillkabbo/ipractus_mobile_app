...
- [x] **AUTH-01**: User can sign up with email and password (mock)
- [x] **AUTH-02**: User can log in with email and password (mock)
- [x] **AUTH-03**: User can enable biometric authentication (Face ID/Touch ID)
- [x] **AUTH-04**: User can reset password via email flow (mock)
- [x] **AUTH-05**: User session persists across app restarts
- [x] **AUTH-06**: User can log out from the app

### Profiles

- [x] **PROF-01**: User can view their own profile
- [x] **PROF-02**: User can edit profile (name, bio, avatar)
- [x] **PROF-03**: User can upload profile avatar image
- [ ] **PROF-04**: User can view other users' profiles
- [x] **PROF-05**: User profile displays Athlete/Coach/Fan role (from API)
...
- [x] **PLAT-01**: App supports dark mode theme
- [x] **PLAT-02**: App supports light mode theme
- [x] **PLAT-03**: User can toggle between dark/light mode
- [x] **PLAT-04**: Theme persists across app restarts
- [x] **PLAT-05**: App uses bottom tab navigation (Feed, Teams, Chat, Profile)
...
| PROF-01 through PROF-03, PROF-05 | Phase 1 | Complete |
...
| PLAT-01 through PLAT-05 | Phase 1 | Complete |
